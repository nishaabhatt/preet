...
const HeaderMain = () => {
  ...
  return (
    ...
    //     <div className=" flex gap-4 text-gray-500 text-[25px] md:text-[30px]">
    //       <BiUser />
  ...
  <div className="container flex justify-between items-center">
    <div className="w-[30%] sm:w-[300px] md:w-[15%] relative">
      <input
        className="border-gray-200 border p-1 text-[10px] md:text-lg md:p-2 px-4 rounded-lg w-full"
        type="text"
        placeholder="Search..."
      />
      <BsSearch
        className="absolute right-0 top-0 mr-3 mt-2 text-gray-400 text-[10px] md:text-xl"
      />
    </div>
    ...
    <div className="flex gap-4 text-gray-500 text-[20px] md:text-[30px]">
      ...
      <div className="relative">
        <FiHeart />
        <div className="bg-red-600 rounded-full absolute top-0 right-0 w-[15px] h-[15px] md:w-[18px] md:h-[18px] text-[8px] md:text-[12px] text-white grid place-items-center translate-x-1 -translate-y-1">
          0
        </div>
      </div>
